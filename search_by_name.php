...
Enter Name : 
<input type="text" size="11" name="name" > 
...
$query1 =mysql_query("SELECT * FROM `employee` WHERE `name`='$name'");  
$query2 = mysql_query("SELECT * FROM `student` WHERE `Fname` LIKE '%r%' ");  

if(mysql_num_rows($query2)==NULL)
{
    //employee
}
else if(mysql_num_rows($query1)==NULL)
{
  
$user=mysql_result($query2,$link );
