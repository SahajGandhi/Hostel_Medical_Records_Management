...
<form action="search_visitlog.php" method = "GET">
Enter student ID : 
<input type="text" size="11" name="id" > 
...
echo '<font type="Verdana" color=#14c8b1>';
...
echo '<strong>Room No. :</strong> '.$room_no.'<br><br><Br>' ;
